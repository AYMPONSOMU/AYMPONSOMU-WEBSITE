...
// Fixed valid JavaScript version
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const musicFiles = [
    'blue-silence.mp3','celestial-breath.mp3','cosmic-peace.mp3',
    'divine-glow.mp3','goldan-energy.mp3','heart-hermony.mp3',
    'inner-light.mp3','moon-serenity.mp3','mystic-guidance.mp3',
    'power-art-awakening.mp3','sacred-space.mp3'
  ];
