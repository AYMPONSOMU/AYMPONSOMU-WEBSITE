...
document.addEventListener('DOMContentLoaded', function () {
  function initDailyImages() {
    ...
    var gallery = [
      images[day % images.length],
      images[(day + 3) % images.length],
      images[(day + 6) % images.length],
      images[(day + 9) % images.length]
    ];
    ...
    section.innerHTML = '<div style="text-align:center;color:#ffd700;font-size:13px;letter-spacing:2px;font-weight:700;margin-bottom:12px">🖼️ AYMP DAILY DISCOVERY GALLERY</div>';
